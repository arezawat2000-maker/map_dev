...
class ChatMessage {
  /// Display label shown to end users for admin-authored messages.
  ...
  /// Label for the user app: admin bubbles always show [userFacingAdminName].
  ...
  /// Label for the admin app: admin bubbles use stored username / email.
